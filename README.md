...
倉鼠可以走到別的地方去。五張地圖：`home` 倉鼠的家（**室內**）· `garden` 後院草地 ·
`park` 大公園 · `street` 熱鬧街道 · `beach` 陽光沙灘（500 金幣解鎖，沿用舊商店的
...
每張地圖有 2~3 個可以點的地方（睡窩、飼料碗、書櫃、花圃、長椅、郵筒、冰淇淋攤、
沙堡、貝殼……）。點一下 → 倉鼠走過去 → 演一小段 → 給獎勵 → 進冷卻。
